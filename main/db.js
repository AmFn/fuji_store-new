...
function normalizePhotoRecord(photo) {
  ...
  return {
    ...
    // 富士相机参数
    film_mode: photo.film_mode,
    dynamic_range: photo.dynamic_range,
    color_chrome: photo.color_chrome,
    color_chrome_blue: photo.color_chrome_blue,
    color_chrome_red: photo.color_chrome_red,
    grain_effect: photo.grain_effect,
    grain_effect_rough: photo.grain_effect_rough,
    highlight_tone: photo.highlight_tone,
    shadow_tone: photo.shadow_tone,
    tone: photo.tone,
    color: photo.color,
    sharpness: photo.sharpness,
    clarity: photo.clarity,
    noise_reduction: photo.noise_reduction,
    high_iso_noise_reduction: photo.high_iso_noise_reduction,
    iso: photo.iso,
    ...
    white_balance_mode: photo.white_balance_mode,
    white_balance_temperature: photo.white_balance_temperature,
    white_balance_tint: photo.white_balance_tint,
    focus_mode: photo.focus_mode,
    focus_area: photo.focus_area,
    af_point: photo.af_point,
    flash_fired: photo.flash_fired,
    flash_mode: photo.flash_mode,
